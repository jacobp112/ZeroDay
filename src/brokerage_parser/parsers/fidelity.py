        ...
        for table in pos_tables:
            ...
            for idx, col_text in enumerate(header_row):
                if "symbol" in col_text or "ticker" in col_text:
                    col_map["symbol"] = idx
                elif "description" in col_text or "name" in col_text or "security" in col_text or "investment" in col_text:
                    col_map["description"] = idx
                elif "quantity" in col_text or "shares" in col_text or "units" in col_text:
                    col_map["quantity"] = idx
                elif "price" in col_text:
                    col_map["price"] = idx
                elif "market value" in col_text or "value" in col_text or "current value" in col_text:
                    col_map["value"] = idx
            ...
            if col_map["symbol"] == -1 and col_map["description"] == -1 and len(table) > 1:
                ...
                for idx, col_text in enumerate(header_row):
                    if "symbol" in col_text or "ticker" in col_text:
                        col_map["symbol"] = idx
                    elif "description" in col_text or "name" in col_text:
                        col_map["description"] = idx
                    elif "quantity" in col_text or "shares" in col_text:
                        col_map["quantity"] = idx
                    elif "price" in col_text:
                        col_map["price"] = idx
